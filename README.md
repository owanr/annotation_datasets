...
| 2018 | [A Broad-Coverage Challenge Corpus for Sentence Understanding through Inference](https://cims.nyu.edu/~sbowman/multinli/paper.pdf) (Williams, Adina and Nangia, Nikita and Bowman, Samuel) | MNLI | [Dataset](https://cims.nyu.edu/~sbowman/multinli/) | :family_man_woman_girl_boy: |  |  |  |  |
| 2015 | [A large annotated corpus for learning natural language inference](https://nlp.stanford.edu/projects/snli/) (Samuel R. Bowman, Gabor Angeli, Christopher Potts, and Christopher D. Manning) |  |  |  |  |  |  |  |
